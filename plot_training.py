...
# ===== Load saved Q-learning training data =====
returns = np.load("episode_returns.npy")  # shape (N,)
scores = np.load("episode_scored_flags.npy")  # 0/1 per episode
conceded = np.load("episode_conceded_flags.npy")  # 0/1 per episode
...
plt.xlabel("Episode")
plt.ylabel("Return")
plt.title("Q-learning Training: Episode Return")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig("ql_training_returns.png", dpi=200)
...
plt.title("Q-learning Training: Scoring Frequency")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig("ql_training_success.png", dpi=200)
...
plt.title("Q-learning Training: Goal Differential")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig("ql_training_goal_diff.png", dpi=200)

print(
    "Saved ql_training_returns.png, ql_training_success.png, ql_training_goal_diff.png"
)
